 ...
 * @version 1.0
 */
public class ColoredSourceSinkNodeVertexRenderer extends VertexRenderer {
   
   private static final long serialVersionUID = 1L;
   
   private static ColoredSourceSinkNodeVertexRenderer instance;
   
   /**
    * Constructor.
    */
   private ColoredSourceSinkNodeVertexRenderer() {
   }
    ...
    * @return instance
    */
   public static ColoredSourceSinkNodeVertexRenderer getInstance() {
      if (instance == null) {
         instance = new ColoredSourceSinkNodeVertexRenderer();
      }
      return instance;
   }
