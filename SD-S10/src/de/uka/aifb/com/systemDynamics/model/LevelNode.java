   ...
   protected LevelNode(String nodeName, double startValue, double min, double max, double curve, boolean learnerChangeable, boolean shared) {
  	...
  	else
  	{
        if (startValue < min || startValue > max) {
            throw new NodeParameterOutOfRangeException(min, max);
         }
  	}
...
/**
   ...
   /**
    * Sets the level node's min value
    * 
    * @param minValue min value allowed across the entire simulation
    */
   ...
   /**
    * Sets the level node's max value
    * 
    * @param maxValue max value allowed across the entire simulation
    */
    ...
    * 
    * @param curve (Non-Decreasing or Non-Increasing or NULL)
    */
   ...
   /**
    * Gets the level node's max value.
    * 
    * @return max value
    */
   ...
   /**
    * Gets the level node's characteristic behaviour
    * 
    * @return curve (Non-Decreasing or Non-Increasing or NULL)
    */
