...
public class FormulaParserTestCase extends TestCase {
   ...
   protected void setUp() throws Exception {
      ...
      id2sharedNode = new HashMap<Integer, SharedNode>();
      id2sharedNode.put(1, sharedNode1);
   }
   ...
   public void testParseFormula1() {
      ...
      // (3) 'id2levelNode, id2sharedNode' == null => WRONG
      try {
         FormulaParser.parseFormula("", id2auxiliaryNode, id2constantNode, null, id2sharedNode);
         fail();
      } catch (IllegalArgumentException e) {
         assertEquals("'id2levelNode, id2sharedNode' must not be null.", e.getMessage());
      } catch (Exception e) {
         fail();
      }
   }
